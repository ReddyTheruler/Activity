...
<head>
	...
	<title>Admin Dashboard | ADVANCE Activity School Project</title>
...
<body class="page-body skin-default" >
 ...
 <!-- ENQUIRY TABLE INFO -->
	...
	<div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
		<h2 style="font-weight:200; margin:0px; color: #FF9900">Activity Activity School Project</h2>
    </div>
...
//        }
			...
			<!-- Footer -->
<footer class="main" align="center" style="color:#FF0000">© 2018 Activity Activity School Project.</footer>
