		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <form action="http://localhost/Activity/index.php?admin/student/create/" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label">To Date </label>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"> <i class="entypo-plus"></i>Find Activites</button>
						</div>
					</div>
                </form>            </div> 
        </div>
