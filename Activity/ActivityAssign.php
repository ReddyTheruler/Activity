  ...
  <li class="active ">
	...
	<div class="col-md-12 col-sm-12 clearfix ">
		...
		<ul class="list-inline links-list pull-right">
			...
			<li>
				<a href="http://localhost/Activity/index.php?login/logout">
		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <form action="http://localhost/Activity/index.php?admin/student/create/" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label">Activity List</label>
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label">Activity Category</label>
					...
					<!--<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label">parent</label>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-success btn-sm btn-icon icon-left"> <i class="entypo-plus"></i>Assign Task for Student</button>
						</div>
					</div>
                </form>            </div> 
        </div>
